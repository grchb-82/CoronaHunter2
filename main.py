...
icon_surf = pygame.image.load("assets/icons/virus.ico")  # Pfad anpassen
...
hit_sound = pygame.mixer.Sound("assets/sounds/mixkit-cartoon-blow-impact-2654.wav")
hit_sound.set_volume(0.7)
hit2_sound = pygame.mixer.Sound("assets/sounds/mixkit-explosion-in-battle-2809.wav")
shot_sound = pygame.mixer.Sound("assets/sounds/mixkit-fast-blow-2144.wav")
shot_sound.set_volume(0.3)
oneup_sound = pygame.mixer.Sound("assets/sounds/mixkit-player-boost-recharging-2040.wav")
pup1_sound = pygame.mixer.Sound("assets/sounds/pup1.ogg")
pup2_sound = pygame.mixer.Sound("assets/sounds/pup2.ogg")
start_sound = pygame.mixer.Sound("assets/sounds/df start snd.wav")
start_sound.set_volume(0.4)
hs_sound = pygame.mixer.Sound("assets/sounds/hs.ogg")
fanfare_sound = pygame.mixer.Sound("assets/sounds/fanfare.ogg")
game_over_sound = pygame.mixer.Sound("assets/sounds/game_over.ogg")
level_complete_sound = pygame.mixer.Sound("assets/sounds/level_complete.ogg")
next_level_sound = pygame.mixer.Sound("assets/sounds/next_level.ogg")
boss_level_background_music = pygame.mixer.Sound("assets/sounds/boss_level_backmuc.ogg")
boss_explosion = pygame.mixer.Sound("assets/sounds/boss_explosion.ogg")
swoosh = pygame.mixer.Sound("assets/sounds/swoosh.ogg")
swoosh.set_volume(0.7)
sparks = pygame.mixer.Sound("assets/sounds/sparks.ogg")
shield_hit_sound = pygame.mixer.Sound("assets/sounds/shield_hit.ogg")
shield_hit_sound.set_volume(1)
pause_sound = pygame.mixer.Sound("assets/sounds/pause.ogg")
unpause_sound = pygame.mixer.Sound("assets/sounds/unpause.ogg")
...
def init():
    ...
    return (
        clock, game_state, gs, player, back1, viruses1, viruses2, vaccines, hearts_all, pups, all_sprites, virus, screen, hit_sound,
...
def main():
    ...
    while outer:
        ...
        #=Show Menu##########################################################################
        Title_Screen(Title,game_surface,screen,Version)
